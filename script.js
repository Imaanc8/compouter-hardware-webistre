const quizData = [
    ...
    {
        question: "Which component is responsible for converting digital data into visual signals on a display?",
        options: ["GPU", "RAM", "CPU", "SSD"],
        answer: "GPU"
    },
    {
        question: "Which type of storage uses magnetic disks to store data?",
        options: ["SSD", "HDD", "USB drive", "CD-ROM"],
        answer: "HDD"
    }
];
...
function celebrateCorrectAnswer() {
    ...
    celebrationMessage.textContent = "🎉 Well done! You got it right! 🎉";
    celebrationMessage.classList.add('celebration');
    feedbackElement.appendChild(celebrationMessage);
}
